...
class HomeRepository {
  ...
  Future<List<Pokemon>> getPokemonSpeciesList(int lastShowedId) {
    QueryOptions<SpeciesTypesResponse> queryOption = QueryOptions(
      document: gql(QuerySpeciesTypes(lastShowedId: lastShowedId).toString()),
      fetchPolicy: FetchPolicy.cacheAndNetwork,
      parserFn: (Map<String, dynamic> response) =>
          SpeciesTypesResponse.fromJson(response),
    );

    return _remoteDataSource.getSpeciesTypes(queryOption).then((value) {
